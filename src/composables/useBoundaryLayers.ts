...
const boundaryVisible = reactive<Record<BoundaryLayerKey, boolean>>({
  coastline: true,
  admin0: true,
  admin1: true,
})
...
export function useBoundaryLayers() {
  ...
  function setBoundaryVisible(layer: BoundaryLayerKey, visible: boolean) {
    boundaryVisible[layer] = visible
  }
